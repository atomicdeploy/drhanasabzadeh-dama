<template>
  ...
  <Header3 v-if="this.show_story===false" @headeropenMenu="this.homeOpenMenu()" />
  ...
  <div v-if="this.geted===2" style="background: black;border-top-right-radius: 10px;border-top-left-radius: 10px;padding-top: 10px">
  ...
  <div v-if="this.geted===2 && this.show_story===false && this.last_views.length>0"  style=" text-align: right;display: block;padding:25px 20px 15px 20px">
    <p class="darktitle" style="font-size: 15px" :class="{ltr_lang:$t('config.dir')==='ltr',rtl_lang:$t('config.dir')==='rtl'}">{{ $t("Home.studyingCourses") }}</p>
  </div>
  ...
  <div v-if="this.geted===2 && this.show_story===false && this.popular.length>0"  style=" text-align: right;display: block;padding:25px 20px 15px 20px">
    <p class="darktitle" style="font-size: 15px" :class="{ltr_lang:$t('config.dir')==='ltr',rtl_lang:$t('config.dir')==='rtl'}">{{ $t("Home.popularCourses") }}</p>
  </div>
  ...
  <div v-if="this.geted===2 && this.show_story===false && this.data.length>0" class="row" style="display: block;padding:25px 20px 15px 20px;">
    <p class="darktitle" style="font-size: 15px" :class="{ltr_lang:$t('config.dir')==='ltr',rtl_lang:$t('config.dir')==='rtl'}">{{ $t("Home.latestCourses") }}</p>
  </div>
  <div v-if="this.geted===2 && this.show_story===false" class="container">
    <div class="scrollrow" :class="{ltr_lang:$t('config.dir')==='ltr',rtl_lang:$t('config.dir')==='rtl'}">
...
export default {
  ...
  components: {
    Loading,SideMenu,Header3,SubHeader,Footer,FontAwesomeIcon,Swiper, SwiperSlide,Rating,Stories,GDialog
  },
  mounted() {
  ...
  methods:{
    ...
    goToChannel(id){
      if(localStorage.getItem('tk')==="" || localStorage.getItem('tk')===null){
        ...
        this.$router.push({ path: '/channel',query:{ ref: id } });
      }
