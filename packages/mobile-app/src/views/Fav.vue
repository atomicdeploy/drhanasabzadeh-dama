<template>
  ...
  <div class="row" v-if="this.geted===2 || this.geted_f===1">
    <p style="font-size: 13px;width: 50%;padding: 3% 2% 3% 0">علاقه مندی ها</p>
  ...
  <div v-else-if="this.geted===2 && this.data.length===0">
   <div class="row" >
    ...
    <div class="row" style="width: 100%;text-align: center">
      <p class="default" style="width: 100%;text-align: center">هیچ دوره ای در علاقه مندی های شما وجود ندارد</p>
    </div>
  </div>
  <Footer :selected_num="2" />
</template>
