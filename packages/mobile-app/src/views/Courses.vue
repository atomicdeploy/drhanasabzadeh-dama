<template>
  ...
  <div class="row" v-if="this.geted===2 || this.geted_f===1">
    ...
    <p v-if="this.pagename!==''" style="font-size: 13px;width: 49%;padding: 3% 2% 3% 3%">{{this.pagename}}</p>
  ...
  <div  v-if="this.geted===2 || this.geted_f===1" class="container" style="padding: 0">
    <div class="scrollrow" style="margin: 3% 3% 0 3%">
      <div  class="card" v-for="cat in data_cat" :key="cat.ID" :class="{ active_card: cat.ID === this.catref,deactive_card:cat.ID !== this.catref }" style="text-align: center;margin-bottom: 1rem !important;height: 150px;margin-left: 4%"  @click="this.change_filter(0,cat.ID)">
        <img :src="this.baseurl+'/images/cat/'+cat.Pic" style="height: 110px;width:auto;border-radius: 10px 10px 0 0">
        <p style="font-size: 13px;height: 23px;text-align: center;padding-top: 5px" class="card-text">{{cat.Name}}</p>
      </div>
    </div>
  </div>

  <div  v-if="this.geted===2 || this.geted_f===1" class="mycard" style="height: 40px;margin:0 4% 0 4%;padding:0 ;width: 92%;border-radius: 25px">
      <div class="row type-of-course" style="padding: 0;margin: 0" >
        <div @click="this.change_filter(1)" :class="{ active: filter === 1,deactive:filter!==1 }" class="filterbar" >
          <div class='outer-div'>
        ...
        <div @click="this.change_filter(2)" :class="{ active: filter === 2,deactive:filter!==2 }"  class="filterbar">
          <div class='outer-div'>
            <div class='middle-div'>
              {{$t('Courses.free')}}
            </div>
        ...
        <div @click="this.change_filter(3)" :class="{ active: filter === 3,deactive:filter!==3 }" class="filterbar">
          <div class='outer-div'>
            <div class='middle-div'>
              {{$t('Courses.shared')}}
            </div>
        ...
        <div @click="this.change_filter(4)" :class="{ active: filter === 4,deactive:filter!==4 }" class="filterbar">
          <div class='outer-div'>
            <div class='middle-div'>
              {{$t('Courses.buyable')}}
            </div>
  ...
  <div  v-if="this.geted===2 && this.data.length>0" style="margin: 10% 3% 0 3%">
